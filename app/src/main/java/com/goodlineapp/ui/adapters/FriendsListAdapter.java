...
public class FriendsListAdapter extends BaseListAdapter<UsersSearchItem>
{
    ...
    private final FriendsListAdapter.OnItemClickListener listener;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        {
            ((SearchItemViewHolder)holder).bind(getItem(position), false);
